...
# Pino do LED no ESP32 (pino 2)
led_pin = 2

# Configuração do detector de mão
cap = cv2.VideoCapture(0)  # Captura da câmera obs: verifique o index da sua, pode ser 0, 1 ou 3
...
board.exit()  # Finaliza a conexão com o ESP32 ao sair do programa
